                        ...
                        <div class="card-body border-bottom py-3">
                            <div class="row ms-5">
                                <form class="row" action="<?php if (isset($update_data)) {
                                                                echo base_url('admin/Category/index/update');
                                                            } else {
                                                                echo base_url('admin/Category/index/add');
                                                            } ?>" method="post">
                                    <div class="col-md-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            ...
                                                            <a class="btn btn-primary" href="<?= base_url('admin/Category/index/edit/') . $data['id'] ?>">
                                                            ...
                                                            <a class="btn btn-danger" onclick="return confirm('Are you sure want to Delete.?');" href="<?= base_url('admin/Category/index/delete/') . $data['id'] ?>">
