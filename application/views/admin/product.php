                            ...
                            <form class="row" action="<?php if (isset($update_data)) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-select select2" name="sub_category_id" id="sub_category">
                                            <option selected>Select subcategory</option>
                                            <?php
                                            $subcategory = $this->db->where('category_id', $name)->get('sub_category')->result();
                                            foreach ($subcategory as $value) {

                                            ?>

                                                <option value="<?= $value->id; ?>" <?php if (isset($update_data) && $value->id == $update_data['sub_category_id']) {
                                                                                        echo 'selected';
                                                                                    } ?>><?= $value->name; ?></option>
                                            <?php } ?>
                                        </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <a class="btn btn-primary" href="<?= base_url('admin/Product/index/edit/') . $data['id'] ?>">
                                                    ...
                                                    <a class="btn btn-danger" onclick="return confirm('Are you sure want to Delete.?');" href="<?= base_url('admin/Product/index/delete/') . $data['id'] ?>">
