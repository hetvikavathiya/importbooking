                    ...
                    <div class="card-body border-bottom py-3">
                        <div class="row ms-5">
                            <form class="row" action="<?php if (isset($update_data)) {
                                                            echo base_url('admin/Party/index/update');
                                                        } else {
                                                            echo base_url('admin/Party/index/add');
                                                        } ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <input class="form-control" type="text" name="name" placeholder="enter party name" value="<?php if (isset($update_data)) {
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input class="form-control" type="city" name="city" placeholder="enter city" value="<?php if (isset($update_data)) {
                                                                                                                                echo $update_data['city'];
                                                                                                                            } ?>" id="city" required>
                                ...
                                <div class="row">
                                    <div class="col-md-2 ">
                                        ...
                                        <input class="btn btn-primary " type="submit" value="<?= isset($update_data) ? "UPDATE" : "ADD" ?> PARTY">
                                    </div>
                                </div>
        ...
        <div class="col-sm-12">
            <div class="card mx-4">
                <div class="card-header">
                    <h3 class="card-title">View Party</h3>
                </div>
                <div class="card-body border-bottom py-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <a class="btn btn-primary" href="<?= base_url('admin/Party/index/edit/') . $data['id'] ?>">
                                                    ...
                                                    <a class="btn btn-danger" onclick="return confirm('Are you sure want to Delete.?');" href="<?= base_url('admin/Party/index/delete/') . $data['id'] ?>">
