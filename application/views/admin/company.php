                    ...
                    <div class="card-body border-bottom py-3">
                        <div class="row ms-5">
                            <form class="row" action="<?php if (isset($update_data)) {
                                                            echo base_url('admin/Company/index/update');
                                                        } else {
                                                            echo base_url('admin/Company/index/add');
                                                        } ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <input class="form-control" type="text" name="name" placeholder="enter company name" value="<?php if (isset($update_data)) {
                                ...
                                <div class="row">
                                    <div class="col-md-2 ">
                                        ...
                                        <input class="btn btn-primary " type="submit" value="<?= isset($update_data) ? "UPDATE" : "ADD" ?> COMPANY">
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <a class="btn btn-primary" href="<?= base_url('admin/Company/index/edit/') . $data['id'] ?>">
                                                    ...
                                                    <a class="btn btn-danger" onclick="return confirm('Are you sure want to Delete.?');" href="<?= base_url('admin/Company/index/delete/') . $data['id'] ?>">
