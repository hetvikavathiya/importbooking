                    ...
                    <div class="card-body border-bottom py-3">
                        <div class="row ms-5">
                            <form class="row" action="<?php if (isset($update_data)) {
                                                            echo base_url('admin/Sub_category/index/update');
                                                        } else {
                                                            echo base_url('admin/Sub_category/index/add');
                                                        } ?>" method="post">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <a class="btn btn-primary" href="<?= base_url('admin/Sub_category/index/edit/') . $data['id'] ?>">
                                                    ...
                                                    <a class="btn btn-danger" onclick="return confirm('Are you sure want to Delete.?');" href="<?= base_url('admin/Sub_category/index/delete/') . $data['id'] ?>">
